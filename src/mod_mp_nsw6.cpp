...
double ln10;                  //< log(10)
double coef_a[10] = { 5.065339, -0.062659, -3.032362, 0.029469, -0.000285,
                      0.31255, 0.000204, 0.003199, 0.0, -0.015952  };
double coef_b[10] = { 0.476221, -0.015896, 0.165977, 0.007468, -0.000141,
...
const double Nc_lnd     = 2000.0;   //< number concentration of cloud water (land)  [1/cc]
const double Nc_ocn     =   50.0;   //< number concentration of cloud water (ocean) [1/cc]
...
const double Ka0        = 2.428E-2; //< thermal diffusion coefficient of air at 0C,1atm [J/m/s/K]
const double dKa_dT     =  7.47E-5; //< Coefficient of Ka depending on temperature      [J/m/s/K/K]
const double Kd0        = 2.222E-5; //< diffusion coefficient of water vapor in the air at 0C,1atm [m2/s]
const double dKd_dT     =  1.37E-7; //< Coefficient of Dw depending on temperature                 [m2/s/K]
const double nu0        = 1.718E-5; //< kinematic viscosity of air at 0C,1atm      [m2/s*kg/m3]
const double dnu_dT     =  5.28E-8; //< Coefficient of mu depending on temperature [m2/s/K*kg/m3]
...
bool OPT_EXPLICIT_ICEGEN = false;
bool OPT_INDIR = false;
bool Roh_flag = false;

double sw_constVto = 0.0;
double CONST_Vti;
...
void mp_nsw6_init()
{
    ...
    if ( Roh_flag ) // overwrite parameters
    {
       std::cout << "*** => Yes\n";

...
{
    drhogqv = View<double**>("drhogqv", kdim, ijdim);
    drhogqc = View<double**>("drhogqc", kdim, ijdim);
    drhogqi = View<double**>("drhogqi", kdim, ijdim);
    drhogqr = View<double**>("drhogqr", kdim, ijdim);
    drhogqs = View<double**>("drhogqs", kdim, ijdim);
    drhogqg = View<double**>("drhogqg", kdim, ijdim);
    psatl = View<double**>("psatl", kdim, ijdim);
    qsatl = View<double**>("qsatl", kdim, ijdim);                
    psati = View<double**>("psati", kdim, ijdim);
    qsati = View<double**>("qsati", kdim, ijdim);                
    Nc    = View<double**>("Nc", kdim, ijdim);                 
    a1  = View<double**>("a1", kdim, ijdim);                 //<
    a2  = View<double**>("a2", kdim, ijdim);                 //<
    ma2 = View<double**>("ma2", kdim, ijdim);                //< 1-a2
    Vt   = View<double***>("Vt  ", nqmax, kdim, ijdim);
    cva  = View<double**> ("cva ", kdim, ijdim);
    rgs  = View<double**> ("rgs ", kdim, ijdim);
    rgsh = View<double**> ("rgsh", kdim, ijdim);
    ml_Pconv = View<double**>("ml_Pconv", kdim, ijdim);
    ml_Pconw = View<double**>("ml_Pconw", kdim, ijdim);
    ml_Pconi = View<double**>("ml_Pconi", kdim, ijdim);
...
{
    // nsw6 big loop
    Kokkos::parallel_for(MDRangePolicy<BigLoopTag, Kokkos::Rank<2>>({kmin,0},{kmax+1,ijdim}), *this);
...
void mp_nsw6_new::operator()(BigLoopTag, const size_t k, const size_t ij) const
{

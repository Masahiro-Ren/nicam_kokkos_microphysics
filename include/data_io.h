...
constexpr size_t SIZE_BUF_2D = ADM_kall * ADM_gall_in * sizeof(double);
...
constexpr size_t SIZE_BUF_4D2 = 2 * ADM_kall * ADM_KNONE * ADM_gall_in * sizeof(double);
...
void read_data_3d(const std::string& filename, double arr4d[ADM_lall][TRC_VMAX][ADM_kall][ADM_gall_in]);
void read_data_3d(const std::string& filename, double arr4d[2][ADM_kall][ADM_KNONE][ADM_gall_in]);
};
